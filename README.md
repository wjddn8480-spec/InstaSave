...
완료 후 다음 경로에 결과가 생성됩니다.

```text
release\InstaSave-win-x64\InstaSave.exe
release\InstaSave-win-x64.zip
```

### Windows 설치 파일 만들기

Inno Setup 6를 설치한 뒤 다음 파일을 실행합니다.
...
```text
release\InstaSave-Setup-x64.exe
```
